...
export function SeletorCondominioPeriodo({
  condominios,
  valoresAtuais,
}: {
  condominios: Opcao[];
  valoresAtuais: { condominioId?: string; meses?: string };
}) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      >
        ...
        <SelectContent>
          <SelectItem value="todos">Todos os condomínios (consolidado)</SelectItem>
          {condominios.map((c) => (
      ...
      <Select
        value={valoresAtuais.meses ?? "12"}
        onValueChange={(v) => atualizar("meses", v)}
      >
